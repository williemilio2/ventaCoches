...
<div className="max-w-3xl mx-auto text-center">
  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary text-sm font-medium mb-6">
    ...
    <p className="text-stroke-white">Tu concesionario de confianza</p>
  </div>

  <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6 text-balance leading-tight text-stroke-white">
    Encuentra tu coche{" "}
